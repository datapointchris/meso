...
<template>
  <ModalShell
    ...
    <p
      ...
      No protocol recorded yet. Until there is one, every reading is only comparable to the others if you happen to remember how you took
      the last one — tap Edit to write down how this is measured.
    </p>
